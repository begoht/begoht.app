import { initSocket } from "./socket.js?v=20260822-driver-gps-real";
import { initMap } from "./map.js?v=20260712-route-700m-small-pins";
import { initGPS } from "./gps.js?v=20260822-driver-gps-real";
import { initOferta } from "./oferta/oferta.index.js?v=20260822-driver-gps-real";
import { initViajeInicio } from "./viajeInicio/viajeInicio.js?v=20260822-driver-gps-real";
import { initViajeFinalizar } from "./viajeFinalizar.js?v=20260822-driver-gps-real";
import { initViajeControl } from "./viajeControl/viajeControl.js?v=20260822-driver-gps-real";
...
import { initDriverStatus } from "./driver.status.js?v=20260822-driver-gps-real";
import { initDriverSpa } from "./driver.spa.js?v=20260822-driver-gps-real";
