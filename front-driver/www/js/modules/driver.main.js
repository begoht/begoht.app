import { initSocket } from "./socket.js?v=20260821-driver-online-fix";
import { initMap } from "./map.js?v=20260712-route-700m-small-pins";
import { initGPS } from "./gps.js?v=20260821-driver-online-fix";
import { initOferta } from "./oferta/oferta.index.js?v=20260821-driver-online-fix";
import { initViajeInicio } from "./viajeInicio/viajeInicio.js?v=20260821-driver-online-fix";
import { initViajeFinalizar } from "./viajeFinalizar.js?v=20260821-driver-online-fix";
import { initViajeControl } from "./viajeControl/viajeControl.js?v=20260821-driver-online-fix";
import { initIdaVueltaDriver } from "./idaVuelta/idaVuelta.driver.js?v=20260627-map-fluid-arrival";
import { initDriverChat } from "./chat/viajeChat.js?v=20260716-chat-history";
import { initDriverStatus } from "./driver.status.js?v=20260821-driver-online-fix";
import { initDriverSpa } from "./driver.spa.js?v=20260821-driver-online-fix";
