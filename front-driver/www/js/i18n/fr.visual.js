(function () {
  ...
  [
    ...
    ["Verificar telefono", "Verifier le telephone"],
    ["Verificar email", "Verifier l'email"],
    ["Te enviaremos un codigo de 6 digitos.", "Nous vous enverrons un code a 6 chiffres."],
    ["Te enviaremos un codigo de 6 digitos a tu correo.", "Nous vous enverrons un code a 6 chiffres par email."],
    ["Codigo SMS", "Code SMS"],
    ["Confirmar codigo", "Confirmer le code"],
    ["Reenviar", "Renvoyer"],
    ["Verificar y crear cuenta", "Verifier et creer le compte"],
    ["Atras", "Retour"],
    ["AtrÃ¡s", "Retour"],
    ["Enviando codigo...", "Envoi du code..."],
    ["Creando cuenta...", "Creation du compte..."],
    ["Ingresando...", "Connexion..."],
    ["Telefono invalido. Usa formato internacional, ejemplo +50937123456", "Telephone invalide. Utilisez le format international, exemple +50937123456"],
    ["No se pudo enviar el codigo", "Impossible d'envoyer le code"],
    ["Ingresa el codigo enviado a tu celular", "Saisissez le code envoye sur votre telephone"],
    ["Ingresa el codigo de 6 digitos", "Saisissez le code a 6 chiffres"],
    ["Codigo invalido", "Code invalide"],
    ["Telefono verificado. Creando cuenta...", "Telephone verifie. Creation du compte..."],
    ["Email verificado. Creando cuenta...", "Email verifie. Creation du compte..."],
    ["Cuenta creada correctamente", "Compte cree correctement"],
    ["La contrasena debe tener minimo 8 caracteres", "Le mot de passe doit contenir au moins 8 caracteres"],
    ["Ingresa el codigo enviado a tu correo", "Saisissez le code envoye par email"],
    ["Email invalido", "Email invalide"],
    ["Las contrasenas no coinciden", "Les mots de passe ne correspondent pas"],
    ["Debes aceptar los terminos", "Vous devez accepter les conditions"],
    ["Completa nombre, email, telefono y contrasena", "Completez nom, email, telephone et mot de passe"],
    ["Registrando...", "Inscription..."],
    ["Registro exitoso. Abriendo login...", "Inscription reussie. Ouverture de la connexion..."],
    ["Error al registrar", "Erreur lors de l'inscription"],
    ["Verificando...", "Verification..."],
    ["Error enviando codigo", "Erreur lors de l'envoi du code"],
    ["Error verificando codigo", "Erreur lors de la verification du code"],
    ["Error de conexion", "Erreur de connexion"],
    ...
    ["Ganancia disponible", "Gain disponible"],
    ["Wallet BeGO para pagos digitales y retiros", "Wallet BeGO pour paiements numeriques et retraits"],
    ["Ganancia efectivo", "Gain en especes"],
    ["No retirable: ya fue cobrada en mano.", "Non retirable: deja encaisse en main."],
    ["Comision pendiente", "Commission en attente"],
    ["PIN Wallet", "PIN Wallet"],
    ["A configurar", "A configurer"],
    ["PIN activo", "PIN actif"],
    ["Crea un PIN privado de 4 digitos para proteger pagos, retiros y comisiones.", "Creez un PIN prive a 4 chiffres pour proteger paiements, retraits et commissions."],
    ["Nuevo PIN", "Nouveau PIN"],
    ["Confirmar PIN", "Confirmer le PIN"],
    ["Repetir", "Repeter"],
    ["Crear PIN wallet", "Creer le PIN wallet"],
    ["No compartas este PIN con pasajeros ni soporte.", "Ne partagez pas ce PIN avec les passagers ni le support."],
    ["Pagar BeGO", "Payer BeGO"],
    ["Usa saldo disponible para pagar la comision pendiente al alias oficial @bego.", "Utilisez le solde disponible pour payer la commission en attente a l'alias officiel @bego."],
    ["Monto", "Montant"],
    ["PIN wallet", "PIN wallet"],
    ["Pagar comision", "Payer commission"],
    ["Si alcanzas el limite, no recibiras nuevas ofertas hasta pagar.", "Si vous atteignez la limite, vous ne recevrez plus d'offres jusqu'au paiement."],
    ["No tienes comision pendiente.", "Vous n'avez aucune commission en attente."],
    ["Crea tu PIN wallet antes de pagar comisiones.", "Creez votre PIN wallet avant de payer les commissions."],
    ["El PIN debe tener 4 digitos.", "Le PIN doit contenir 4 chiffres."],
    ["Los PIN no coinciden.", "Les PIN ne correspondent pas."],
    ["Elige un PIN mas seguro.", "Choisissez un PIN plus securise."],
    ["Guardando", "Enregistrement"],
    ["PIN wallet creado correctamente.", "PIN wallet cree correctement."],
    ["No se pudo crear el PIN wallet.", "Impossible de creer le PIN wallet."],
  ...
  const regexRules = [
    ...
    [/^Codigo enviado a\s+(.+)\.\s+Expira en\s+(\d+)\s+minutos\.$/i, (_, phone, minutes) => `Code envoye a ${phone}. Expire dans ${minutes} minutes.`],
    [/^ID\s+(.+)$/i, (_, id) => `ID ${id}`]
  ];
