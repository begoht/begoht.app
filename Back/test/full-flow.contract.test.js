...
test("mapa en viaje: conserva colores, refuerza etiquetas y elimina fondo y borde", () => {
  ...
  assert.doesNotMatch(mapSingleton, /bego-map-surface/);
  ...
  assert.match(driverMap, /pane:\s*"overlayPane"/);
  assert.match(driverMap, /conectarRutaAExtremos\(coords, origenCoord, destinoCoord\)/);
