...
import { initHeader } from "../../components/header.init.js?v=20260713-profile-photo-stable";
...
async function initHome(initId) {
    ...
    const { initPasajero } = await import("../../pasajero/pasajero.main.js?v=20260821-promo-autoplay");
