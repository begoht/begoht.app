...
import { restoreViajeUI } from "./app.restore.js?v=20260627-map-fluid-arrival";
...
async function initHome(initId) {
    ...
    const { initPasajero } = await import("../../pasajero/pasajero.main.js?v=20260627-map-fluid-arrival");
