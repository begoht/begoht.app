...
import { restoreViajeUI } from "./app.restore.js?v=20260619-clear-map-address";
...
async function initHome(initId) {
    ...
    const { initPasajero } = await import("../../pasajero/pasajero.main.js?v=20260619-clear-map-address");
