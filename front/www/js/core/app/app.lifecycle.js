...
import { restoreViajeUI } from "./app.restore.js?v=20260619-map-ref-button";
...
async function initHome(initId) {
    ...
    const { initPasajero } = await import("../../pasajero/pasajero.main.js?v=20260619-map-ref-button");
