...
import { restoreViajeUI } from "./app.restore.js?v=20260618-map-ref-reserve";
...
async function initHome(initId) {
    ...
    const { initPasajero } = await import("../../pasajero/pasajero.main.js?v=20260618-map-ref-reserve");
