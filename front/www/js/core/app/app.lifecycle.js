...
import { restoreViajeUI } from "./app.restore.js?v=20260603-road-heading-stable";
...
async function initHome(initId) {
    ...
    const { initPasajero } = await import("../../pasajero/pasajero.main.js?v=20260603-road-heading-stable");
