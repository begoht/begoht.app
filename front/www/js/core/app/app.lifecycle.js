...
import { restoreViajeUI } from "./app.restore.js?v=20260607-finalized-guard";
...
async function initHome(initId) {
    ...
    const { initPasajero } = await import("../../pasajero/pasajero.main.js?v=20260607-finalized-guard");
