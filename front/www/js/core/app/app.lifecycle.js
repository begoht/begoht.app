...
import { restoreViajeUI } from "./app.restore.js?v=20260628-map-single-layer";
...
async function initHome(initId) {
    ...
    const { initPasajero } = await import("../../pasajero/pasajero.main.js?v=20260628-map-single-layer");
