import { initGeo } from "../map/map.geo.js?v=20260618-map-ref-reserve";
import { initSeleccionDestino } from "../map/map.destino.js?v=20260618-map-ref-reserve";
...
import { initPasajeroSocket } from "../socket/pasajero.socket.js?v=20260618-map-ref-reserve";
import { setMapa, limpiarMotoristas } from "../map/map.motorista.js?v=20260618-map-ref-reserve";
import { initSavedDestinations } from "../map/map.saved-destinations.js?v=20260618-map-ref-reserve";
