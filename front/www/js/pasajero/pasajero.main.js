...
import { initPasajeroSocket } from "../socket/pasajero.socket.js?v=20260701-follow-zoom";
import { setMapa, limpiarMotoristas } from "../map/map.motorista.js?v=20260701-follow-zoom";
