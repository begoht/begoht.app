...
import { initPasajeroSocket } from "../socket/pasajero.socket.js?v=20260628-dark-route-locked";
import { setMapa, limpiarMotoristas } from "../map/map.motorista.js?v=20260628-dark-route-locked";
