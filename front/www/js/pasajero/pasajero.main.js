import { initGeo } from "../map/map.geo.js?v=20260625-map-instant";
import { initSeleccionDestino } from "../map/map.destino.js?v=20260625-map-instant";
...
import { initPasajeroSocket } from "../socket/pasajero.socket.js?v=20260625-return-cancel";
import { setMapa, limpiarMotoristas } from "../map/map.motorista.js?v=20260625-map-instant";
import { initSavedDestinations } from "../map/map.saved-destinations.js?v=20260625-map-instant";
import { initEnvioPaquete } from "./envio.paquete.js?v=20260625-map-instant";
