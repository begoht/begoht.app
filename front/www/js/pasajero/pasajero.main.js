import { initGeo } from "../map/map.geo.js?v=20260627-map-fluid-arrival";
import { initSeleccionDestino } from "../map/map.destino.js?v=20260627-map-fluid-arrival";
...
import { initPasajeroSocket } from "../socket/pasajero.socket.js?v=20260627-map-fluid-arrival";
import { setMapa, limpiarMotoristas } from "../map/map.motorista.js?v=20260627-map-fluid-arrival";
import { initSavedDestinations } from "../map/map.saved-destinations.js?v=20260627-map-fluid-arrival";
import { initEnvioPaquete } from "./envio.paquete.js?v=20260627-map-fluid-arrival";
