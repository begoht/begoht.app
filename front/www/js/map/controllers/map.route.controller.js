import {
  ...
  dibujarRutaReserva,
  limpiarRutas
} from "../map.ruta.js?v=20260628-map-locked-motion";
...
import {
  ...
  setRouteState,
  resetRouteState
} from "../state/map.route.state.js?v=20260628-map-locked-motion";

import {
  getMap,
  isMapReady
} from "../map.singleton.js?v=20260628-map-locked-motion";
