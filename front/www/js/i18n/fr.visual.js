(function () {
  ...
  [
    ...
    ["Usa MITAD y revisa el precio antes de confirmar.", "Utilisez MITAD et verifiez le prix avant de confirmer."],
    ...
    ["Segun disponibilidad", "Selon disponibilite"],
    ...
    ["Promos en servicios seleccionados.", "Promos sur certains services."],
    ...
    ["Compra saldo con recibo firmado.", "Achetez du credit avec recu signe."],
    ["Asistencia", "Assistance"],
    ["Soporte listo para ayudarte en produccion.", "Assistance prete a vous aider en production."],
    ["Soporte listo para ayudarte.", "Assistance prete a vous aider."],
