...
import { handleAsignado } from "./handlers/asignado.handler.js?v=20260618-passenger-map-full";
import { handleTrack } from "./handlers/track.handler.js?v=20260618-passenger-map-full";
import { handleLlego } from "./handlers/llego.handler.js?v=20260618-passenger-map-full";
import { handleIniciado } from "./handlers/iniciado.handler.js?v=20260618-passenger-map-full";
...
import { handleSync } from "./handlers/sync.handler.js?v=20260618-passenger-map-full";
import { handleEstado } from "./handlers/estado.handler.js?v=20260618-passenger-map-full";
