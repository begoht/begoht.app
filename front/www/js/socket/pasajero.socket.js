...
import { handleAsignado } from "./handlers/asignado.handler.js?v=20260624-map-light";
import { handleTrack } from "./handlers/track.handler.js?v=20260624-map-light";
import { handleLlego } from "./handlers/llego.handler.js?v=20260620-map-rotation";
import { handleIniciado } from "./handlers/iniciado.handler.js?v=20260624-map-light";
...
import { handleSync } from "./handlers/sync.handler.js?v=20260624-map-light";
...
} from "./handlers/idaVuelta.handler.js?v=20260624-map-light";
